          ...
          <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {availableSkills.map((skill) => (
                  <div key={skill} className="flex items-center">
                    <input
                      ...
                      className="mr-2 h-4 w-4 text-ocean-600 focus:ring-ocean-500 border-gray-300 rounded"
                    />
            ...
            <div className="pt-6">
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-ocean-500 hover:bg-ocean-600 disabled:bg-gray-400 text-white py-3 px-4 rounded-lg transition-colors flex items-center justify-center gap-2 text-sm font-medium"
              >
                {loading ? (
                  <>
...
export default function VolunteerRegisterPage() {
  return (
    <Suspense fallback={
      <div className="min-h-[100dvh] w-full flex items-center justify-center bg-gradient-to-b from-ocean-50 via-cyan-50 to-teal-50">
        <Loader2 className="h-8 w-8 animate-spin text-ocean-500" />
      </div>
    }>
